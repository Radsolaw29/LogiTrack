...
{
    public class TransportOrderQueryValidatorTests
    {
        private readonly TransportOrderQueryValidator _validator;

        public TransportOrderQueryValidatorTests()
        {
            _validator = new TransportOrderQueryValidator();
        }
        ...
        public void Validate_ForInvalidPageSizes_ShouldReturnsValidationError(int pageSize)
        {
            ...
            var queru = new TransportOrderQuery
            {
                PageNumber = 1,
                PageSize = pageSize
            };
        ...
        public void Validate_ForInvalidSortBy_ShouldReturnsValidationError()
        {
            ...
            result.ShouldHaveValidationErrorFor(x => x.SortBy)
                .WithErrorMessage("Sort by is optional, or must be in [OrderName,Description]");
        }
    }
}
